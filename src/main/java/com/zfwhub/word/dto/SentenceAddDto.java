...
public class SentenceAddDto implements DtoEntity {

    private String content;
    private Integer wordCategoryRelationId;
    
    public SentenceAddDto() { }

    public SentenceAddDto(String content, Integer wordCategoryRelationId) {
    ...
    public boolean equals(Object obj) {
        ...
        if (getClass() != obj.getClass())
            return false;
        SentenceAddDto other = (SentenceAddDto) obj;
        if (content == null) {
